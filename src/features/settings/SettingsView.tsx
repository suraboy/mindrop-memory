    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-8 py-8 sm:py-12 space-y-8">
      ...
      <header className="space-y-1.5">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          Manage LINE ingestion, AI synthesis preferences, and memory storage.
        </p>
      </header>
      ...
      {/* Section 2: AI Memory Preferences */}
      ...
      {/* Section 3: Memory Storage & Export */}
      <section className="p-6 rounded-2xl border border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-4 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">
              Local vector embeddings &amp; semantic index data.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 text-center">
          <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800">
            <div className="text-base font-semibold text-zinc-900 dark:text-zinc-100">124</div>
            <div className="text-[11px] text-zinc-500">Total Captures</div>
          </div>
          <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800">
            <div className="text-base font-semibold text-zinc-900 dark:text-zinc-100">18</div>
            <div className="text-[11px] text-zinc-500">AI Topic Clusters</div>
          </div>
          <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800">
            <div className="text-base font-semibold text-zinc-900 dark:text-zinc-100">4.2 MB</div>
            <div className="text-[11px] text-zinc-500">Vector Index Size</div>
          </div>
        </div>
